(function($){
  ...
  $.fn.copyOnClick.defaults = {
    ...
    confirmShow:true,
    confirmClass:"tooltip",
    confirmText:"Ссылка скопирована",
    confirmTime:1.5,
    beforeCopy:null,
    afterCopy:null,
    confirmPopup:function(str,target,c,t,txt,x,y) {
      ...
      var $pop=$('<div class="'+c+' copy-on show bs-tooltip-top" style="top: -38px;left:-.4rem" role="tooltip" data-popper-placement="top"> <div class="tooltip-arrow" style="left: 50%;margin-left: -0.4rem;"></div><div class="tooltip-inner">'+s+'</div></div>');
      target.after($pop);
